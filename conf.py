...
BLOG_AUTHOR = "A. Asensio Ramos"  # (translatable)
BLOG_TITLE = "My work notebook"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://aasensio.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://aasensio.github.io/"
BLOG_EMAIL = "aasensioramos@gmail.com"
BLOG_DESCRIPTION = "My work"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('http://www.iac.es/project/inversion', 'About me', 'icon-user'),
        ('https://twitter.com/aasensior', 'My Twitter', 'icon-twitter'),
        ('https://github.com/aasensio', 'My Github', 'icon-github'),
    )
}
...
DEPLOY_COMMANDS = ["rm -rf /scratch/Dropbox/aasensio.github.io/*",
                   "cp -r output/* /scratch/Dropbox/aasensio.github.io/",
                   "./nikola-deploy"]
# DEPLOY_COMMANDS = {
#     'default': [
#         "rsync -rav --delete output/ joe@my.site:/srv/www/site",
